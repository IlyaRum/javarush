    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println( this.getName() + ":" + OnlineGame.steps.get( 1 ) );
                Thread.sleep( 1000 / this.rating );
                System.out.println( this.getName() + ":" + OnlineGame.steps.get( 2 ) );
                Thread.sleep( 1000 / this.rating );
                System.out.println( this.getName() + ":" + OnlineGame.steps.get( 3 ) );
                Thread.sleep( 1000 / this.rating );
